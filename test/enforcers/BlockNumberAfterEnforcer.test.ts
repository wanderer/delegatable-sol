...
describe("BlockNumberAfterEnforcer", () => {
  ...
  before(async () => {
    ...
    BlockNumberAfterEnforcerFactory = await ethers.getContractFactory(
  ...
  beforeEach(async () => {
    ...
    BlockNumberEnforcer = await BlockNumberAfterEnforcerFactory.connect(
      wallet0
    ).deploy();
